...
/**
 * @功能:recyclerview 网格布局的分割线
 * @Creat 2019/05/16 16:30
 * @User Lmy
 * @By Android Studio
 */
public class RecyclerViewTieku extends RecyclerView.ItemDecoration {
    private Drawable mDivider;
    private boolean mShowLastLine;
    private int mHorizonSpan;
    private int mVerticalSpan;

    private RecyclerViewTieku(int horizonSpan, int verticalSpan, int color, boolean showLastLine) {
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
    ...
    public static class Builder {
        ...
        public RecyclerViewTieku build() {
            return new RecyclerViewTieku(mHorizonSpan, mVerticalSpan, mColor, mShowLastLine);
        }
    }
