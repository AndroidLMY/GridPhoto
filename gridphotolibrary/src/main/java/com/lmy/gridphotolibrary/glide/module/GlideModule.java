 ...
 * com.lmy.gridphotolibrary.glide.GlideBuilder} and registering {@link com.lmy.gridphotolibrary.glide.load.model.ModelLoader
 * ModelLoaders}.
 *
 ...
 *       Registry#prepend(Class, Class, com.lmy.gridphotolibrary.glide.load.ResourceDecoder)} for each {@link
 *       com.lmy.gridphotolibrary.glide.load.model.ModelLoader} you'd like to register:
 *       <pre>
 *                  <code>
 ...
 *       <pre>{@code
 * -keepnames class * com.lmy.gridphotolibrary.glide.samples.flickr.FlickrGlideModule
 * }</pre>
 ...
 *       <pre>{@code
 * <meta-data
 *     android:name="com.lmy.gridphotolibrary.glide.samples.flickr.FlickrGlideModule"
