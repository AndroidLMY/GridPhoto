...
public interface Transformation<T> extends Key {
   ...
   * com.lmy.gridphotolibrary.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *     com.lmy.gridphotolibrary.glide.request.target.Target#SIZE_ORIGINAL} to indicate the original resource
   *     width.
