...
/**
 * A simple {@link com.lmy.gridphotolibrary.glide.load.Transformation} for transforming {@link
 * Bitmap}s that abstracts away dealing with {@link
 * com.lmy.gridphotolibrary.glide.load.engine.Resource} objects for subclasses.
 *
 ...
 *     private static final String ID = "com.lmy.gridphotolibrary.glide.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   * com.lmy.gridphotolibrary.glide.request.target.Target#SIZE_ORIGINAL}, this class converts them to be the
   * size of the Bitmap we're going to transform before calling this method.
   *
   * @param pool A {@link com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.BitmapPool} that can be used
