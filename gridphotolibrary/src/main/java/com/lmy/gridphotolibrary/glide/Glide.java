...
import com.lmy.gridphotolibrary.glide.GlideBuilder.EnableImageDecoderForBitmaps;
import com.lmy.gridphotolibrary.glide.gifdecoder.GifDecoder;
import com.lmy.gridphotolibrary.glide.load.DecodeFormat;
import com.lmy.gridphotolibrary.glide.load.ImageHeaderParser;
import com.lmy.gridphotolibrary.glide.load.ResourceDecoder;
import com.lmy.gridphotolibrary.glide.load.data.InputStreamRewinder;
import com.lmy.gridphotolibrary.glide.load.data.ParcelFileDescriptorRewinder;
import com.lmy.gridphotolibrary.glide.load.engine.Engine;
import com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.ArrayPool;
import com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.BitmapPool;
import com.lmy.gridphotolibrary.glide.load.engine.cache.MemoryCache;
import com.lmy.gridphotolibrary.glide.load.engine.prefill.BitmapPreFiller;
import com.lmy.gridphotolibrary.glide.load.engine.prefill.PreFillType;
import com.lmy.gridphotolibrary.glide.load.engine.prefill.PreFillType.Builder;
import com.lmy.gridphotolibrary.glide.load.model.AssetUriLoader;
import com.lmy.gridphotolibrary.glide.load.model.ByteArrayLoader;
import com.lmy.gridphotolibrary.glide.load.model.ByteBufferEncoder;
import com.lmy.gridphotolibrary.glide.load.model.ByteBufferFileLoader;
import com.lmy.gridphotolibrary.glide.load.model.DataUrlLoader;
import com.lmy.gridphotolibrary.glide.load.model.FileLoader;
import com.lmy.gridphotolibrary.glide.load.model.GlideUrl;
import com.lmy.gridphotolibrary.glide.load.model.MediaStoreFileLoader;
import com.lmy.gridphotolibrary.glide.load.model.ResourceLoader;
import com.lmy.gridphotolibrary.glide.load.model.StreamEncoder;
import com.lmy.gridphotolibrary.glide.load.model.StringLoader;
import com.lmy.gridphotolibrary.glide.load.model.UnitModelLoader;
import com.lmy.gridphotolibrary.glide.load.model.UriLoader;
import com.lmy.gridphotolibrary.glide.load.model.UrlUriLoader;
import com.lmy.gridphotolibrary.glide.load.model.stream.HttpGlideUrlLoader;
import com.lmy.gridphotolibrary.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.lmy.gridphotolibrary.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.lmy.gridphotolibrary.glide.load.model.stream.QMediaStoreUriLoader;
import com.lmy.gridphotolibrary.glide.load.model.stream.UrlLoader;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.BitmapEncoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.ByteBufferBitmapImageDecoderResourceDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.HardwareConfigState;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.InputStreamBitmapImageDecoderResourceDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.ParcelFileDescriptorBitmapDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.VideoDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.bytes.ByteBufferRewinder;
import com.lmy.gridphotolibrary.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.drawable.UnitDrawableDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.file.FileDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.gif.ByteBufferGifDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable;
import com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawableEncoder;
import com.lmy.gridphotolibrary.glide.load.resource.gif.GifFrameResourceDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.gif.StreamGifDecoder;
import com.lmy.gridphotolibrary.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.lmy.gridphotolibrary.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.lmy.gridphotolibrary.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.lmy.gridphotolibrary.glide.load.resource.transcode.GifDrawableBytesTranscoder;
import com.lmy.gridphotolibrary.glide.manager.ConnectivityMonitorFactory;
import com.lmy.gridphotolibrary.glide.manager.RequestManagerRetriever;
import com.lmy.gridphotolibrary.glide.module.ManifestParser;
import com.lmy.gridphotolibrary.glide.request.RequestListener;
import com.lmy.gridphotolibrary.glide.request.RequestOptions;
import com.lmy.gridphotolibrary.glide.request.target.ImageViewTargetFactory;
import com.lmy.gridphotolibrary.glide.request.target.Target;
 ...
 * com.lmy.gridphotolibrary.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private static void initializeGlide(
    ...
    List<com.lmy.gridphotolibrary.glide.module.GlideModule> manifestModules = Collections.emptyList();
    ...
    if (annotationGeneratedModule != null
      ...
      Iterator<com.lmy.gridphotolibrary.glide.module.GlideModule> iterator = manifestModules.iterator();
      while (iterator.hasNext()) {
        com.lmy.gridphotolibrary.glide.module.GlideModule current = iterator.next();
    ...
    if (Log.isLoggable(TAG, Log.DEBUG)) {
      for (com.lmy.gridphotolibrary.glide.module.GlideModule glideModule : manifestModules) {
    ...
    for (com.lmy.gridphotolibrary.glide.module.GlideModule module : manifestModules) {
    ...
    try {
      Class<GeneratedAppGlideModule> clazz =
          (Class<GeneratedAppGlideModule>)
              Class.forName("com.lmy.gridphotolibrary.glide.GeneratedAppGlideModuleImpl");
      result =
  ...
  /**
   * Returns the {@link com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.BitmapPool} used to
   ...
   * com.lmy.gridphotolibrary.glide.load.ResourceDecoder}s and {@link com.lmy.gridphotolibrary.glide.load.Transformation}s.
