...
/** A request that loads a resource for an {@link com.lmy.gridphotolibrary.glide.request.target.Target}. */
public interface Request {
   ...
   * com.lmy.gridphotolibrary.glide.request.target.Target}s (for example). Using a similar but different method
