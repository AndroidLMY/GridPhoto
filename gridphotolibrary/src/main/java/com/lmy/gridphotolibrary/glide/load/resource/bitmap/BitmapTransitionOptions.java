...
import com.lmy.gridphotolibrary.glide.TransitionOptions;
import com.lmy.gridphotolibrary.glide.request.transition.BitmapTransitionFactory;
import com.lmy.gridphotolibrary.glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions
   ...
   *
   * @see com.lmy.gridphotolibrary.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see com.lmy.gridphotolibrary.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
