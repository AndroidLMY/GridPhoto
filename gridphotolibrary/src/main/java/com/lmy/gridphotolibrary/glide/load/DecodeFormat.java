package com.lmy.gridphotolibrary.glide.load;

/**
 * Options for setting the value of {@link android.graphics.Bitmap#getConfig()} for {@link
 * android.graphics.Bitmap}s returned by {@link com.lmy.gridphotolibrary.glide.load.ResourceDecoder}s.
 *
 * <p>Note - In some cases it may not be possible to obey the requested setting, not all {@link
 * com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler}s support setting formats and certain images
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.lmy.gridphotolibrary.glide.load.ResourceDecoder}. should return {@link
   ...
   * use {@link com.lmy.gridphotolibrary.glide.request.RequestOptions#disallowHardwareConfig()}.
   *
