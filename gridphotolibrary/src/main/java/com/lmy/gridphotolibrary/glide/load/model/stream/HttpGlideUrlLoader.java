...
import com.lmy.gridphotolibrary.glide.load.data.HttpUrlFetcher;
import com.lmy.gridphotolibrary.glide.load.model.GlideUrl;
import com.lmy.gridphotolibrary.glide.load.model.ModelCache;
...
/**
 * An {@link com.lmy.gridphotolibrary.glide.load.model.ModelLoader} for translating {@link
 * com.lmy.gridphotolibrary.glide.load.model.GlideUrl} (http/https URLS) into {@link InputStream} data.
 */
// Public API.
...
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT =
      Option.memory("com.lmy.gridphotolibrary.glide.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);
