 ...
 * differ depending on the {@link com.lmy.gridphotolibrary.glide.load.ResourceDecoder} using the strategy and
 ...
 * com.lmy.gridphotolibrary.glide.load.Transformation} either instead or in addition to a {@code
 * DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and {@link
 * com.lmy.gridphotolibrary.glide.load.ResourceDecoder}s are listed below, but the list is not comprehensive
 ...
 * is supported. To preserve the potential for a {@link com.lmy.gridphotolibrary.glide.load.Transformation} to
...
public abstract class DownsampleStrategy {
  ...
  public static final Option<DownsampleStrategy> OPTION =
      Option.memory(
          "com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler.DownsampleStrategy", DEFAULT);
