...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     * com.lmy.gridphotolibrary.glide.request.RequestOptions#override(int, int)} to do so.
     *
  ...
  /**
   * Constructor for {@link com.lmy.gridphotolibrary.glide.ListPreloader} that accepts interfaces for providing
