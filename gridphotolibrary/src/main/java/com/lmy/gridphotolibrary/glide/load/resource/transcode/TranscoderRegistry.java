...
/**
 * A class that allows {@link com.lmy.gridphotolibrary.glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link com.lmy.gridphotolibrary.glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * com.lmy.gridphotolibrary.glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
