package com.lmy.gridphotolibrary.glide.request;
...
import com.lmy.gridphotolibrary.glide.load.MultiTransformation;
...
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.CenterCrop;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.CenterInside;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.CircleCrop;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.DownsampleStrategy;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.DrawableTransformation;
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.FitCenter;
...
import com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawableTransformation;
import com.lmy.gridphotolibrary.glide.load.resource.gif.GifOptions;
import com.lmy.gridphotolibrary.glide.signature.EmptySignature;
import com.lmy.gridphotolibrary.glide.util.CachedHashCodeArrayMap;
 ...
 * com.lmy.gridphotolibrary.glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.lmy.gridphotolibrary.glide.request.target.Target}'s size before
   ...
   *     com.lmy.gridphotolibrary.glide.request.target.Target}'s dimensions when loading the resource.
   ...
   * com.lmy.gridphotolibrary.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.lmy.gridphotolibrary.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.lmy.gridphotolibrary.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * com.lmy.gridphotolibrary.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  @NonNull
  @CheckResult
   ...
   * com.lmy.gridphotolibrary.glide.load.resource.bitmap.DownsampleStrategy.CenterOutside} can safely use {@link
   ...
   * com.lmy.gridphotolibrary.glide.load.model.stream.HttpGlideUrlLoader}. If you use any other networking
   * library including Glide's Volley or OkHttp integration libraries, this option will be ignored.
   *
   * @see com.lmy.gridphotolibrary.glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link com.lmy.gridphotolibrary.glide.load.resource.bitmap.CenterCrop} to all default types, and
  ...
  /**
   * Applies {@link com.lmy.gridphotolibrary.glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable}) and throws an exception if asked to
   ...
   * Applies the given {@link Transformation} for {@link Bitmap Bitmaps} to the default types
   * ({@link Bitmap}, {@link BitmapDrawable}, and {@link
   * com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformation Any {@link Transformation} for {@link Bitmap}s.
   ...
   * com.lmy.gridphotolibrary.glide.TransitionOptions#dontTransition()}
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
  @NonNull
