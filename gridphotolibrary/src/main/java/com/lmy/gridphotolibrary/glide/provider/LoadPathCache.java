package com.lmy.gridphotolibrary.glide.provider;
...
import com.lmy.gridphotolibrary.glide.load.resource.transcode.UnitTranscoder;
import com.lmy.gridphotolibrary.glide.util.MultiClassKey;
import java.util.Collections;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available {@link
 * com.lmy.gridphotolibrary.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
