...
import com.lmy.gridphotolibrary.glide.GlideBuilder;

/** An internal interface, to be removed when {@link GlideModule}s are removed. */
@Deprecated
interface AppliesOptions {
  /**
   * Lazily apply options to a {@link com.lmy.gridphotolibrary.glide.GlideBuilder} immediately before the Glide
   * singleton is created.
   *
   * <p>This method will be called once and only once per implementation.
   *
   * @param context An Application {@link Context}.
   * @param builder The {@link com.lmy.gridphotolibrary.glide.GlideBuilder} that will be used to create Glide.
   */
