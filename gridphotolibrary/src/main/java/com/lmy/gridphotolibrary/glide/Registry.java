...
import com.lmy.gridphotolibrary.glide.load.ResourceEncoder;
import com.lmy.gridphotolibrary.glide.load.data.DataRewinder;
import com.lmy.gridphotolibrary.glide.load.data.DataRewinderRegistry;
import com.lmy.gridphotolibrary.glide.load.engine.DecodePath;
import com.lmy.gridphotolibrary.glide.load.engine.LoadPath;
...
import com.lmy.gridphotolibrary.glide.load.model.ModelLoaderRegistry;
import com.lmy.gridphotolibrary.glide.load.resource.transcode.ResourceTranscoder;
import com.lmy.gridphotolibrary.glide.load.resource.transcode.TranscoderRegistry;
import com.lmy.gridphotolibrary.glide.provider.EncoderRegistry;
import com.lmy.gridphotolibrary.glide.provider.ImageHeaderParserRegistry;
import com.lmy.gridphotolibrary.glide.provider.LoadPathCache;
import com.lmy.gridphotolibrary.glide.provider.ModelToResourceClassCache;
import com.lmy.gridphotolibrary.glide.provider.ResourceDecoderRegistry;
import com.lmy.gridphotolibrary.glide.provider.ResourceEncoderRegistry;
import com.lmy.gridphotolibrary.glide.util.pool.FactoryPools;
...
public class Registry {
   ...
   *     {@link com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable} etc).
   ...
   * com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link com.lmy.gridphotolibrary.glide.load.data.DataRewinder.Factory} to handle a
  ...
  /**
   * Thrown when no {@link com.lmy.gridphotolibrary.glide.load.model.ModelLoader} is registered for a given
   * model class.
   */
