...
import com.lmy.gridphotolibrary.glide.Glide.RequestOptionsFactory;
import com.lmy.gridphotolibrary.glide.GlideExperiments.Experiment;
import com.lmy.gridphotolibrary.glide.load.DataSource;
import com.lmy.gridphotolibrary.glide.load.engine.Engine;
import com.lmy.gridphotolibrary.glide.load.engine.GlideException;
...
import com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.lmy.gridphotolibrary.glide.load.engine.cache.DiskCache;
import com.lmy.gridphotolibrary.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.lmy.gridphotolibrary.glide.load.engine.cache.LruResourceCache;
import com.lmy.gridphotolibrary.glide.load.engine.cache.MemoryCache;
import com.lmy.gridphotolibrary.glide.load.engine.cache.MemorySizeCalculator;
import com.lmy.gridphotolibrary.glide.load.engine.executor.GlideExecutor;
import com.lmy.gridphotolibrary.glide.manager.ConnectivityMonitorFactory;
import com.lmy.gridphotolibrary.glide.manager.DefaultConnectivityMonitorFactory;
import com.lmy.gridphotolibrary.glide.manager.RequestManagerRetriever;
import com.lmy.gridphotolibrary.glide.manager.RequestManagerRetriever.RequestManagerFactory;
import com.lmy.gridphotolibrary.glide.request.BaseRequestOptions;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link com.lmy.gridphotolibrary.glide.load.engine.cache.MemoryCache} implementation to store
   * {@link com.lmy.gridphotolibrary.glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link com.lmy.gridphotolibrary.glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link com.lmy.gridphotolibrary.glide.load.engine.cache.DiskCache} to use to store {@link
   * com.lmy.gridphotolibrary.glide.load.engine.Resource} data on disk.
   *
   ...
   * com.lmy.gridphotolibrary.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving {@link
   * com.lmy.gridphotolibrary.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable} or {@link
  ...
  /**
   * Sets the {@link com.lmy.gridphotolibrary.glide.manager.ConnectivityMonitorFactory} to use to notify {@link
   * com.lmy.gridphotolibrary.glide.RequestManager} of connectivity events. If not set {@link
   * com.lmy.gridphotolibrary.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
   ...
   * com.lmy.gridphotolibrary.glide.request.target.Target}s which are subsequently de-referenced and garbage
   ...
   * load resources into {@link com.lmy.gridphotolibrary.glide.request.target.Target}s and then never clear the
   * {@link com.lmy.gridphotolibrary.glide.request.target.Target}. To do so, Glide uses {@link
   * java.lang.ref.WeakReference}s to track resources that belong to {@link
   * com.lmy.gridphotolibrary.glide.request.target.Target}s that haven't yet been cleared. Setting this method
   * to {@code true} allows Glide to also maintain a hard reference to the underlying resource so
   * that if the {@link com.lmy.gridphotolibrary.glide.request.target.Target} is garbage collected, Glide can
   ...
   * resources into {@link com.lmy.gridphotolibrary.glide.request.target.Target}s but never clear them.
   *
   ...
   * com.lmy.gridphotolibrary.glide.request.target.Target} used to load the {@link Bitmap}. However, if you set
   ...
   * com.lmy.gridphotolibrary.glide.request.target.Target}s when you're done with the corresponding resource.
   * Clearing {@link com.lmy.gridphotolibrary.glide.request.target.Target}s allows Glide to maximize resource
   ...
   * com.lmy.gridphotolibrary.glide.load.engine.GlideException#setOrigin(Exception)} for failed requests.
   *
   ...
   * com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler} and {@link android.graphics.BitmapFactory}
   ...
   * may still be used as part of {@link com.lmy.gridphotolibrary.glide.load.Transformation}s because {@link
   * android.graphics.ImageDecoder} does not support Bitmap re-use.
   *
   * <p>When this flag is enabled {@link
   * com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler#FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS} is
   * ignored. All other {@link com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler} flags are
