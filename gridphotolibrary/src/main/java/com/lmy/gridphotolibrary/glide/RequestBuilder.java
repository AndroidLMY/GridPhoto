...
import static com.lmy.gridphotolibrary.glide.request.RequestOptions.diskCacheStrategyOf;
import static com.lmy.gridphotolibrary.glide.request.RequestOptions.signatureOf;
import static com.lmy.gridphotolibrary.glide.request.RequestOptions.skipMemoryCacheOf;
...
import com.lmy.gridphotolibrary.glide.load.engine.DiskCacheStrategy;
import com.lmy.gridphotolibrary.glide.request.BaseRequestOptions;
import com.lmy.gridphotolibrary.glide.request.ErrorRequestCoordinator;
import com.lmy.gridphotolibrary.glide.request.FutureTarget;
import com.lmy.gridphotolibrary.glide.request.Request;
import com.lmy.gridphotolibrary.glide.request.RequestCoordinator;
import com.lmy.gridphotolibrary.glide.request.RequestFutureTarget;
...
import com.lmy.gridphotolibrary.glide.request.SingleRequest;
import com.lmy.gridphotolibrary.glide.request.ThumbnailRequestCoordinator;
import com.lmy.gridphotolibrary.glide.request.target.PreloadTarget;
import com.lmy.gridphotolibrary.glide.request.target.Target;
import com.lmy.gridphotolibrary.glide.request.target.ViewTarget;
import com.lmy.gridphotolibrary.glide.signature.AndroidResourceSignature;
import com.lmy.gridphotolibrary.glide.util.Executors;
 ...
 *     com.lmy.gridphotolibrary.glide.request.target.Target}.
 */
// Public API.
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
   ...
   * com.lmy.gridphotolibrary.glide.load.model.ModelLoader}, {@link com.lmy.gridphotolibrary.glide.load.ResourceDecoder},
   * and {@link com.lmy.gridphotolibrary.glide.load.Transformation}s. However, {@link
   * com.lmy.gridphotolibrary.glide.request.RequestOptions#placeholder(int)} and {@link
   * com.lmy.gridphotolibrary.glide.request.RequestOptions#error(int)}, and {@link #listener(RequestListener)}
   ...
   * by default, consider registering a custom {@link com.lmy.gridphotolibrary.glide.load.model.ModelLoader} or
   * {@link com.lmy.gridphotolibrary.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * com.lmy.gridphotolibrary.glide.load.model.ModelLoader} or {@link com.lmy.gridphotolibrary.glide.load.ResourceDecoder}
   ...
   * com.lmy.gridphotolibrary.glide.request.RequestOptions#signature(com.lmy.gridphotolibrary.glide.load.Key)} to mixin a
   ...
   * com.lmy.gridphotolibrary.glide.load.engine.DiskCacheStrategy#NONE} and/or {@link
   * com.lmy.gridphotolibrary.glide.request.RequestOptions#skipMemoryCache(boolean)} may be appropriate.
   *
   * @see #load(Object)
   * @param string A file path, or a uri or url handled by {@link
   *     com.lmy.gridphotolibrary.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * com.lmy.gridphotolibrary.glide.load.model.ModelLoaderFactory} currently registered or {@link Integer} to
   * load the image represented by the given {@link Integer} resource id. Defaults to {@link
   * com.lmy.gridphotolibrary.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * consider using {@link com.lmy.gridphotolibrary.glide.load.engine.DiskCacheStrategy#NONE} via {@link
   * RequestOptions#diskCacheStrategy(com.lmy.gridphotolibrary.glide.load.engine.DiskCacheStrategy)} during
   * development, and re-enabling the default {@link
   * com.lmy.gridphotolibrary.glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds.
   *
   ...
   * com.lmy.gridphotolibrary.glide.load.Transformation}s to these {@link Drawable}s by either extracting the
   ...
   * transformed (other than {@link com.lmy.gridphotolibrary.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link com.lmy.gridphotolibrary.glide.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see #load(Integer)
   * @see com.lmy.gridphotolibrary.glide.signature.AndroidResourceSignature
   */
  @NonNull
  @CheckResult
  @Override
   ...
   * @return The {@link com.lmy.gridphotolibrary.glide.request.target.Target} used to wrap the given {@link
   *     ImageView}.
   */
  @NonNull
   ...
   *     overridden by {@link com.lmy.gridphotolibrary.glide.request.RequestOptions#override(int, int)} if
   *     previously called.
   ...
   *     RequestManager#clear(Target)}.
   * @see com.lmy.gridphotolibrary.glide.ListPreloader
   */
  @NonNull
