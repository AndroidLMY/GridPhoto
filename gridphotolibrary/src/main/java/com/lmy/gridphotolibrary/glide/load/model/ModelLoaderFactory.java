 ...
 * {@link com.lmy.gridphotolibrary.glide.module.LibraryGlideModule#registerComponents(Context, Glide, Registry)}
 * in most cases.
 *
 * @param <T> The type of the model the {@link com.lmy.gridphotolibrary.glide.load.model.ModelLoader}s built by
 *     this factory can handle
 * @param <Y> The type of data the {@link com.lmy.gridphotolibrary.glide.load.model.ModelLoader}s built by this
 *     factory can load.
 */
