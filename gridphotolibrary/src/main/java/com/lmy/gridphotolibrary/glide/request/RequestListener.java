...
public interface RequestListener<R> {
   ...
   * use {@link com.lmy.gridphotolibrary.glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, com.lmy.gridphotolibrary.glide.request.transition.Transition)}.
   *
   * <p>For threading guarantees, see the class comment.
   *
