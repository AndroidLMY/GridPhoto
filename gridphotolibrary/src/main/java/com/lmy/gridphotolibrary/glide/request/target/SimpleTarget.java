...
/**
 * A simple {@link com.lmy.gridphotolibrary.glide.request.target.Target} base class with default (usually no-op)
 ...
 * to the previous instance and either call {@link com.lmy.gridphotolibrary.glide.RequestManager#clear(Target)}
 * on the old instance before starting a new load or you must re-use the old instance for the new
 * load. Glide's {@link com.lmy.gridphotolibrary.glide.RequestBuilder#into(Target)} method returns the {@link
 ...
 * calling {@link com.lmy.gridphotolibrary.glide.RequestManager#clear(Target)} and you should always null out
