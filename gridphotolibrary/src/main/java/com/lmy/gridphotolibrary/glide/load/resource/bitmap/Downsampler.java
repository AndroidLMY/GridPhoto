...
import com.lmy.gridphotolibrary.glide.load.ImageHeaderParser.ImageType;
import com.lmy.gridphotolibrary.glide.load.Option;
import com.lmy.gridphotolibrary.glide.load.Options;
import com.lmy.gridphotolibrary.glide.load.PreferredColorSpace;
...
import com.lmy.gridphotolibrary.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
import com.lmy.gridphotolibrary.glide.request.RequestOptions;
import com.lmy.gridphotolibrary.glide.request.target.Target;
import com.lmy.gridphotolibrary.glide.util.LogTime;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT =
      Option.memory(
          "com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  ...
  public static final Option<PreferredColorSpace> PREFERRED_COLOR_SPACE =
      Option.memory(
          "com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler.PreferredColorSpace",
          PreferredColorSpace.SRGB);
  /**
   * Indicates the {@link com.lmy.gridphotolibrary.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * com.lmy.gridphotolibrary.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   * <p>This option is ignored unless we're on Android O+.
   */
  public static final Option<Boolean> ALLOW_HARDWARE_CONFIG =
      Option.memory(
          "com.lmy.gridphotolibrary.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", false);
   ...
   * provided {@link com.lmy.gridphotolibrary.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * com.lmy.gridphotolibrary.glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match those
