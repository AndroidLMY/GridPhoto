...
import com.lmy.gridphotolibrary.glide.load.EncodeStrategy;
...
import com.lmy.gridphotolibrary.glide.load.data.BufferedOutputStream;
...
import com.lmy.gridphotolibrary.glide.util.pool.GlideTrace;
import java.io.File;
...
/**
 * An {@link com.lmy.gridphotolibrary.glide.load.ResourceEncoder} that writes {@link Bitmap}s
...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
  ...
  public static final Option<Integer> COMPRESSION_QUALITY =
      Option.memory("com.lmy.gridphotolibrary.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);
  ...
  public static final Option<Bitmap.CompressFormat> COMPRESSION_FORMAT =
      Option.memory("com.lmy.gridphotolibrary.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");
