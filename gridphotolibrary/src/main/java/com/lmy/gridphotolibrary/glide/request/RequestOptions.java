...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link com.lmy.gridphotolibrary.glide.request.RequestOptions} with {@link #encodeQuality(int)}
  ...
  /**
   * Returns a {@link com.lmy.gridphotolibrary.glide.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link com.lmy.gridphotolibrary.glide.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @NonNull
