...
import com.lmy.gridphotolibrary.glide.load.data.DataFetcher.DataCallback;
import com.lmy.gridphotolibrary.glide.load.model.ModelLoader;
import com.lmy.gridphotolibrary.glide.load.model.ModelLoader.LoadData;
import com.lmy.gridphotolibrary.glide.util.LogTime;
import com.lmy.gridphotolibrary.glide.util.Synthetic;
import java.util.Collections;

/**
 * Generates {@link com.lmy.gridphotolibrary.glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link com.lmy.gridphotolibrary.glide.load.model.ModelLoader ModelLoaders} and the model
