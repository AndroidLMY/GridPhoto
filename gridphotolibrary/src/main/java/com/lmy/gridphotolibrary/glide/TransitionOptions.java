...
import com.lmy.gridphotolibrary.glide.request.transition.NoTransition;
import com.lmy.gridphotolibrary.glide.request.transition.TransitionFactory;
import com.lmy.gridphotolibrary.glide.request.transition.ViewAnimationFactory;
import com.lmy.gridphotolibrary.glide.request.transition.ViewPropertyAnimationFactory;
import com.lmy.gridphotolibrary.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<
   ...
   *
   * @param animator The {@link com.lmy.gridphotolibrary.glide.request.transition.ViewPropertyTransition
   *     .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * com.lmy.gridphotolibrary.glide.request.transition.Transition} for each request started with these {@code
   * TransitionOptions}.
   *
   * @return This request builder.
   */
