...
public abstract class DiskCacheStrategy {
   ...
   * com.lmy.gridphotolibrary.glide.load.data.DataFetcher} and the {@link
   * com.lmy.gridphotolibrary.glide.load.EncodeStrategy} of the {@link com.lmy.gridphotolibrary.glide.load.ResourceEncoder}
   * (if an {@link com.lmy.gridphotolibrary.glide.load.ResourceEncoder} is available).
   */
   ...
   *     com.lmy.gridphotolibrary.glide.load.ResourceEncoder} will use to encode the resource.
   */
