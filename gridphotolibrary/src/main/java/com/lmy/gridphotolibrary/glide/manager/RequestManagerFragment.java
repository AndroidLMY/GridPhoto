 ...
 * com.lmy.gridphotolibrary.glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.lmy.gridphotolibrary.glide.manager.SupportRequestManagerFragment
 * @see com.lmy.gridphotolibrary.glide.manager.RequestManagerRetriever
 * @see com.lmy.gridphotolibrary.glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.lmy.gridphotolibrary.glide.RequestManager}.
   *
  ...
  /** Returns the current {@link com.lmy.gridphotolibrary.glide.RequestManager} or null if none exists. */
  @Nullable
